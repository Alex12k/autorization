...
function login(): void
{
    ...
    if (isset($_SESSION['registration_success'])) {
        ...
        unset($_SESSION['registration_success']); // Удаляем сообщение после показа
    }
                    ...
                    <form method="POST" class="space-y-6">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <a href="<?= url('forgot-password') ?>" class="text-sm text-blue-600 hover:text-blue-700 font-medium">
                                    Забыли пароль?
                                </a>
                            </div>
                            <div class="relative">
