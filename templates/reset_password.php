            ...
            <div class="max-w-md w-full space-y-8">
                ...
                <?php if ($reset_success): ?>
                    ...
                    <div class="bg-white rounded-lg shadow-xl p-8">
                        ...
                        <a href="<?= url('login') ?>" 
                           class="block w-full bg-gradient-to-r from-green-500 to-blue-600 text-white py-3 px-4 rounded-lg font-semibold hover:from-green-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 text-center">
                    ...
                    <div class="bg-white rounded-lg shadow-xl p-8">
                        ...
                        <div class="space-y-3">
                            <a href="<?= url('forgot-password') ?>" 
                               class="block w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 px-4 rounded-lg font-semibold hover:from-blue-600 hover:to-purple-700 transition-all duration-300 text-center">
                                <i class="ri-mail-send-line mr-2"></i>
                                Запросить новую ссылку
                            </a>
                            <a href="<?= url('login') ?>" 
                               class="block w-full bg-gray-300 text-gray-700 py-3 px-4 rounded-lg font-semibold hover:bg-gray-400 transition-colors text-center">
