...
function renderAuthNavigation(): void
{
    ...
    if ($isAuthenticated && $user): ?>
        ...
        <?php if (hasRole('admin')): ?>
            <a href="/admin" class="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium transition-colors">
    ...
    <?php else: ?>
        ...
        <a href="#" class="open_modal_login_form text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium transition-colors cursor-pointer">
