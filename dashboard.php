    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <div class="space-y-3">
                    <a href="index.php" class="block bg-orange-500 text-white py-2 px-4 rounded hover:bg-orange-600 transition-colors text-center">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <div class="space-y-3">
                    <a href="admin.php" class="block bg-red-500 text-white py-2 px-4 rounded hover:bg-red-600 transition-colors text-center">
    ...
    <footer class="bg-gray-800 text-white py-6 mt-12">
        <div class="container mx-auto px-4 text-center">
            <p class="text-gray-300">
                ...
                Система аутентификации PHP 8.4
            </p>
        </div>
    </footer>
</body>
