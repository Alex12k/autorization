...
<div class="min-h-screen authorization-ajax-container flex items-center justify-center bg-gradient-to-br from-purple-50 to-blue-50 px-4">
    <div class="max-w-md w-full text-center">
        ...
        <div class="space-y-3">
            ...
            <?php else: ?>
                <a href="/" class="open_modal_login_form block w-full bg-gray-200 text-gray-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-300 transition-colors cursor-pointer">
